...
*Winner* (model blend)
  England        model 50.6% · mkt 50.0% (betfair_ex_uk)  EV +1.3% ✅+EV (below +2% gate)  $14.05
  Draw           model 25.5% · mkt 26.0% (Smarkets)  EV -1.8% ❌−EV
  Norway         model 23.8% · mkt 24.4% (betfair_ex_uk)  EV -2.3% ❌−EV  (<25% model — NO CASH)
