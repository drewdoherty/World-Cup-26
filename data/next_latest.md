...
*Winner* (model blend)
  England        model 51.8% · mkt 51.5% (betfair_ex_uk)  EV +0.5% ✅+EV (below +2% gate)  $5.42
  Draw           model 25.6% · mkt 25.6% (Smarkets)  EV -0.3% ❌−EV
  Norway         model 22.7% · mkt 23.3% (betfair_ex_uk)  EV -2.6% ❌−EV  (<25% model — NO CASH)
