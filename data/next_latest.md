...
*Winner* (model blend)
  Spain          model 59.0% · mkt 59.5% (betfair_ex_uk)  EV -0.8% ❌−EV
  Belgium        model 17.1% · mkt 16.7% (betfair_ex_uk)  EV +2.5% ✅+EV  (<25% model — NO CASH)
  Draw           model 23.9% · mkt 24.4% (betfair_ex_uk)  EV -2.1% ❌−EV  (<25% model — NO CASH)
