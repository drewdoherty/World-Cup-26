...
*Winner* (model blend)
  England        model 51.8% · mkt 51.5% (betfair_ex_uk)  EV +0.4% ✅+EV (below +2% gate)  $5.15
  Draw           model 25.5% · mkt 26.0% (betfair_ex_uk)  EV -1.7% ❌−EV
  Norway         model 22.7% · mkt 23.3% (betfair_ex_uk)  EV -2.4% ❌−EV  (<25% model — NO CASH)
