...
*Winner* (model blend)
  England        model 50.8% · mkt 50.0% (betfair_ex_uk)  EV +1.5% ✅+EV (below +2% gate)  $16.66
  Draw           model 25.5% · mkt 26.0% (betfair_ex_uk)  EV -1.9% ❌−EV
  Norway         model 23.7% · mkt 24.4% (betfair_ex_uk)  EV -2.6% ❌−EV  (<25% model — NO CASH)
