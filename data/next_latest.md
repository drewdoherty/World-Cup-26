...
*Winner* (model blend)
  Spain          model 58.9% · mkt 59.5% (betfair_ex_uk)  EV -1.1% ❌−EV
  Belgium        model 17.2% · mkt 16.1% (betfair_ex_uk)  EV +6.6% ✅+EV  (<25% model — NO CASH)
  Draw           model 23.9% · mkt 25.0% (betfair_ex_uk)  EV -4.4% ❌−EV  (<25% model — NO CASH)

*Corners* (model, exp 9.0)
  O/U 8.5: over 54.2% / under 45.8% (model only — no live corners feed, +EV unverifiable)

*Top goalscorers* — from the cached /goalscorers card (as of 2026-07-10T07:36:56)
...
*Scorelines* (top 6)
1-1 11.2% | 2-1 10.8% | 1-0 9.9% | 2-0 9.6% | 3-1 6.6% | 3-0 5.9%
