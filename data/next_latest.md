...
*Winner* (model blend)
  France         model 51.2% · mkt 51.8% (betfair_ex_uk)  EV -1.3% ❌−EV
...
*Top goalscorers* — from the cached /goalscorers card (as of 2026-07-18T00:56:30)
_top anytime, mkt implied % (both teams — add squad to split + FGS; no model price, +EV unverifiable)_
  ...
  Ousmane Dembele      mkt 31% (Betfair)
  Ivan Toney           mkt 29% (Betfair)
  Ollie Watkins        mkt 29% (Betfair)

*Scorelines* (top 6)
1-1 11.5% | 1-0 10.9% | 2-1 10.4% | 2-0 8.9% | 0-0 6.6% | 0-1 6.2%
