...
*Winner* (model blend)
  Spain          model 58.5% · mkt 59.2% (betfair_ex_uk)  EV -1.1% ❌−EV
  Belgium        model 17.4% · mkt 16.7% (betfair_ex_uk)  EV +4.2% ✅+EV  (<25% model — NO CASH)
...
*Top goalscorers* — from the cached /goalscorers card (as of 2026-07-09T19:11:24)
_top anytime, mkt implied % (both teams — add squad to split + FGS; no model price, +EV unverifiable)_
  ...
  Lamine Yamal         mkt 36% (Betfair)
  Nico Williams        mkt 31% (William Hill)
  Ferran Torres Garcia mkt 30% (Betfair)
  Victor Munoz         mkt 29% (William Hill)

*Scorelines* (top 6)
1-1 11.3% | 2-1 10.7% | 1-0 9.8% | 2-0 9.6% | 3-1 6.6% | 3-0 5.9%
