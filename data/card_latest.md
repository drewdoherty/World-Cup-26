...
*1. [MID·2ND-FAV] France vs Spain* — Spain — back *29.9%* impl via *betfair*
    model 30.5% / mkt 30.0% (+0.6pp)  EV *+2.2%* ✅+EV  [elo 26% dc 35%]
    stake: gbp £7.54  further-out (78h) — thin/soft market

*— CUT (excluded from staking, 1) —*
  x [LS] Argentina vs Switzerland — Switzerland — back 16.1% impl (model 16.5%, EV +2.3% ✅+EV): below 20% hit-probability floor (model 16.5%) — too unlikely to return PnL even at +2.3% EV
...
*— WATCH (near-threshold, below the +2% EV floor — NOT staked, 3) —*
  ...
  ~ [MID] France vs Spain — France — back 40.7% impl via betfair (model 40.7% / mkt 40.6%, EV +0.1% ✅+EV)

*Venue split (gbp):* betfair £7.54
