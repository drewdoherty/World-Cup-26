...
*— CUT (excluded from staking, 2) —*
  x [LS] Spain vs Belgium — Belgium — back 16.1% impl (model 17.2%, EV +6.6% ✅+EV): below 20% hit-probability floor (model 17.2%) — too unlikely to return PnL even at +6.6% EV
