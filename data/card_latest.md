...
*1. [ML·FAV] Norway vs England* — England — back *52.1%* impl via *betfair*
    model 53.4% / mkt 52.2% (+1.3pp)  EV *+2.5%* ✅+EV  [elo 46% dc 58%]
    stake: gbp £22.11  further-out (54h) — thin/soft market

*— CUT (excluded from staking, 3) —*
  x [LS] Spain vs Belgium — Belgium — back 16.7% impl (model 18.5%, EV +10.9% ✅+EV): below 20% hit-probability floor (model 18.5%) — too unlikely to return PnL even at +10.9% EV
  x [LS] France vs Morocco — Morocco — back 13.9% impl (model 16.5%, EV +9.2% ✅+EV): below 20% hit-probability floor (model 16.5%) — too unlikely to return PnL even at +9.2% EV
...
*— WATCH (near-threshold, below the +2% EV floor — NOT staked, 2) —*
  ~ [ML] Argentina vs Switzerland — Argentina — back 57.5% impl via betfair (model 57.7% / mkt 56.9%, EV +0.4% ✅+EV)
  ~ [MID] France vs Morocco — Draw — back 25.0% impl via betfair (model 25.6% / mkt 24.5%, EV +1.3% ✅+EV)

*Venue split (gbp):* betfair £22.11
...
*France vs Morocco*
    ...
    1-1  11.6%  back at impl <= 11.4%
    0-0  10.5%  back at impl <= 10.3%
    2-1  9.8%  back at impl <= 9.6%
    0-1  6.6%  back at impl <= 6.5%
