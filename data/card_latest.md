...
*— CUT (excluded from staking, 1) —*
  x [LS] Argentina vs Switzerland — Switzerland — back 15.6% impl (model 16.3%, EV +4.2% ✅+EV): below 20% hit-probability floor (model 16.3%) — too unlikely to return PnL even at +4.2% EV

*— WATCH (near-threshold, below the +2% EV floor — NOT staked, 4) —*
  ~ [ML] Argentina vs Switzerland — Argentina — back 56.8% impl via smarkets (model 57.3% / mkt 56.9%, EV +0.9% ✅+EV)
  ~ [ML] Norway vs England — England — back 49.5% impl via betfair (model 50.3% / mkt 49.5%, EV +0.8% ✅+EV)
  ~ [MID] France vs Spain — Spain — back 29.9% impl via betfair (model 30.4% / mkt 29.8%, EV +1.8% ✅+EV)
  ~ [MID] France vs Spain — France — back 40.7% impl via betfair (model 40.8% / mkt 40.8%, EV +0.4% ✅+EV)
