...
*— WATCH (near-threshold, below the +2% EV floor — NOT staked, 5) —*
  ~ [ML] Norway vs England — England — back 50.0% impl via betfair (model 50.8% / mkt 49.9%, EV +1.5% ✅+EV)
  ~ [ML] Argentina vs Switzerland — Argentina — back 57.1% impl via smarkets (model 57.6% / mkt 57.2%, EV +0.7% ✅+EV)
  ~ [MID] France vs Spain — Spain — back 29.9% impl via betfair (model 30.3% / mkt 29.7%, EV +1.3% ✅+EV)
  ~ [MID] France vs Spain — France — back 40.7% impl via betfair (model 41.0% / mkt 41.0%, EV +0.9% ✅+EV)
  ~ [LS] Argentina vs Switzerland — Switzerland — back 16.1% impl via betfair (model 16.4% / mkt 16.2%, EV +1.7% ✅+EV)
