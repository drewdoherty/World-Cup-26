...
PROMPT = (
    ...
    "branding, wordmark, or distinctive brand colour. STRONG bet365 cues: a "
    "green theme with a 'BET BUILDER' wordmark, green circular tick "
    "checkmarks beside each leg, and a bottom navigation bar showing "
    "'In-Play' / 'My Bets' / 'Casino' with an account balance in a corner — "
    "'Bet Builder' is a bet365 feature, so return \"bet365\". Other cues: "
    "blue=Sky Bet/William Hill, a green/white 'Paddy Power' wordmark or a "
    "'Power Price'/'PP' boost = Paddy Power, a Bet ID printed as "
    "'O/<digits>/...' or 'I/<digits>/...' indicates Betfair Sportsbook. For a "
    "GBP combined bet shown with bet365's green Bet-Builder styling and no "
    "other bookmaker's wordmark visible, default to \"bet365\". null only if "
